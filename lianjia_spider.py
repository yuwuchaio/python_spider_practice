...
def do_xiaoqu_spider(db_xq,region=u'杨浦'):
    """
       爬取大区域中的所有小区信息
       """
    url = 'https://sh.lianjia.com/xiaoqu/rs' + region + '/'
    try:
...
def chengjiao_spider(db_cj=None,url_page=u"https://sh.lianjia.com/chengjiao/rs%E9%94%A6%E7%BB%A3%E6%B1%9F%E5%8D%97"):
    """
        爬取页面链接中的成交记录
        """
    try:
